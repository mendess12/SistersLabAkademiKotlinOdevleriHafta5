...
import com.example.sisterslabakademikotlinodevlerihafta5.databinding.CarItemBinding

class CarAdapter(private val mContext: Context, private val carList: List<Cars>) :
